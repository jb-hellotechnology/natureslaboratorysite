...
<html lang="en">
  <head>
    ...
    <title>Natures Laboratory Offers</title>
    ...
    <main>
        ...
        <section class="grid">
	        ...
	        <div class="card herbal flow">
	            ...
	            <p><a class="site-link" href="https://herbalapothecaryuk.com/contact">Contact Us</a></p>
	        </div>
		</section>
        ...
        <section class="grid">
	        <div class="card sweetcecilys flow">
	            ...
	            <p><a class="site-link" href="https://sweetcecilys.com/">Shop Now</a></p>
	        </div>
		</section>
		<h2>BeeVital</h2>
        <section class="grid">
