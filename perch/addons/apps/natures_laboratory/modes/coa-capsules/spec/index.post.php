...
?>
            <tr>
                ...
                <td><a href="<?php echo $HTML->encode($API->app_path()); ?>/coa-capsules/spec/edit/?id=<?php echo $HTML->encode(urlencode($Spec->natures_laboratory_coa_capsules_specID())); ?>" class="button button-small action-info"><?php echo 'View/Edit'; ?></a></td>
                <td><a href="<?php echo $HTML->encode($API->app_path()); ?>/coa-capsules/spec/delete/?id=<?php echo $HTML->encode(urlencode($Spec->natures_laboratory_coa_capsules_specID())); ?>" class="button button-small action-alert"><?php echo 'Delete'; ?></a></td>
            </tr>
<?php
	}
?>
