<?php
    ...
    if($Form->submitted()) {
        ...
        $postvars = array('productType','productCode','commonName','biologicalSource','plantPart','cas','einecs','manufacturingMethod','countryOfOrigin','colour','odour','appearance','specificGravity','refractiveIndex','opticalRotation');	   
