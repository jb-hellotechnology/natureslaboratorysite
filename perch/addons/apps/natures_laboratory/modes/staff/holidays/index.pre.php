<?php
    ...
    if($staffID){
		...
		if($Form->submitted()) {
			...
			// Additional headers
			$headers[] = 'From: info@natureslaboratory.co.uk';
			$headers[] = 'Cc: info@natureslaboratory.co.uk';
