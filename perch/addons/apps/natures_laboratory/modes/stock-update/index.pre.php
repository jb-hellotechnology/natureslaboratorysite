...
*/
    ...
    foreach($export as $row){
		...
		$data = array($handle, $name, "", "", "", "", "", "", "Title", "Default Title", "", "", "", "", "", "", "", "$qty", "deny", "manual", "$row[SALES_PRICE]", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "active");
    ...
    foreach($export as $row){
		...
		if($trade=='T'){
			...
			$data = array($handle, $name, "", "", "", "", "", "", "Title", "Default Title", "", "", "", "", "", "", "", "$qty", "continue", "manual", "$row[SALES_PRICE]", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "active");
