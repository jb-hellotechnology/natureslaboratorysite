...
*/
    ...
    include('../../Natures_Laboratory.task.class.php');
    include('../../Natures_Laboratory.tasks.class.php');
    ...
    include('../../modes/tasks/delete/index.pre.php');
    ...
    # Display your page
    include('../../modes/tasks/delete/index.post.php');
